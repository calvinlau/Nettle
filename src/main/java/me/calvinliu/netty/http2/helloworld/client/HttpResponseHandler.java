 ...
 * the License.
 */
package me.calvinliu.netty.http2.helloworld.client;
...
public class HttpResponseHandler extends SimpleChannelInboundHandler<FullHttpResponse> {
     ...
     * @see me.calvinliu.netty.http2.helloworld.client.HttpResponseHandler#awaitResponses(long, java.util.concurrent.TimeUnit)
     */
     ...
     * @see me.calvinliu.netty.http2.helloworld.client.HttpResponseHandler#put(int, io.netty.channel.ChannelFuture, io.netty.channel.ChannelPromise)
     */
